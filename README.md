...
- Track workshop levels and Scrappy progress with separate card views under one shared tracker.
...
- The page saves locally in your browser and includes a reset button for a fresh wipe.
