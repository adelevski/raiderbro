...
- `icon.png` is the 512px rasterized composition. The app icon (116px), favicon (32px), Apple touch icon (180px) and snowball card (256px) use the same composition with transparent corners.
